...
def find_active_bots(request):
    ...
    botdirs = [f.name for f in os.scandir('bots') if f.is_dir() and not f.name == '__pycache__']
...
class Index(LoginRequiredMixin, View):
    ...
    def get(self, request, chatid=None):
        ...
        self.wordlistpath = PATHS2WORDLISTS[chatsession.bot.name]
    ...
    def get_autocomplete(self):
        ...
        :return:
        """
        with open(self.wordlistpath, 'r', encoding='utf8') as f:
